...
finite-dimensional degree-one multiplication
  + compatible point evaluations separating degree one
  -> internal coordinate Gram realization
  -> the Gram kernel vanishes on every evaluation vector
  -> closed cone generated by squares

degree-two generation
