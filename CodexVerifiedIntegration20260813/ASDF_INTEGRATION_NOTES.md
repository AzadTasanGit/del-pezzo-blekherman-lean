# ASDF integration notes

These modules were checked against Lean `v4.33.0-rc2` and mathlib commit
`51e6992efd06126df61a496bebf8f49482a4e129`. They are staged in the writable integration
directory because macOS currently permits metadata lookup but denies content reads for the
pre-existing PDF and project files directly under `/Users/azad/Documents/Lean/ASDF`.
...
## `ArtinianGorensteinCoreScratch.lean` and `SoclePerfectPairingScratch.lean`
...
## `NonrealPairInertiaScratch.lean` and `RealFiberInertiaBridgeScratch.lean`
...
## `ReciprocalHyperplaneScratch.lean`
...
## `MixedReciprocalHyperplaneScratch.lean`
...
## `NegativeDirectionsBuilderScratch.lean` and `ComplexBlockNegativeScratch.lean`
...
## `EvaluationHyperplaneScratch.lean`
...
## `ProjectiveBasepointScratch.lean` and `SOSLengthProjectiveScratch.lean`
...
## `SOSLengthPerturbationScratch.lean`
...
## `RealProjectiveTopologyScratch.lean` and `SOSLengthRealProjectiveScratch.lean`
...
## `AnalyticNonzeroDenseScratch.lean` and `ProjectivePolynomialDenseScratch.lean`
...
## `HVectorRealDensityScratch.lean`
...
## `SOSLengthContinuousDenseScratch.lean`
...
- proves exact minimal SOS length `m+1`; `HVectorRealDensityScratch.lean` separately supplies the
...
## `RealFiberCountFormulaScratch.lean`
...
## `RealFiberFamilyCountScratch.lean`
...
## `SOSLengthFiberFamilyScratch.lean`
...
## `RealProjectiveCoordinateFiberScratch.lean`
...
## `ProjectiveGoodCoordinatesScratch.lean` and `HVectorGoodFiberFamilyScratch.lean`
...
## `RealFiberComplexBlockFamilyScratch.lean` and `HVectorGoodFiberPairScratch.lean`
...
`RationalClosedPointLiftScratch.lean`, `CoordinateFiberRationalLiftScratch.lean`,
`HVectorGoodFiberRationalLiftScratch.lean`, and `HVectorGoodFiberRealCountScratch.lean`:
...
## `EvaluationContinuityBasisScratch.lean`
...
## `ExtremeSeparatorScratch.lean` and `SOSConeDualScratch.lean`
...
## `PSDRangeOneExtremeScratch.lean`
...
## `ConditionalSeparationScratch.lean`
