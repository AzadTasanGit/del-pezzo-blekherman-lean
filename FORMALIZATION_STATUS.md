...
| Lemmas 4.1--4.2 and Theorem 4.3 | `extreme_psd_evaluation_or_basepointFree`, `kernel_dimension_and_rank_from_perfect_quotient` | compiling with dependency | exact ray dichotomy and perfect-pairing dimension/rank conclusion proved conditionally; basepoint-free parameter sequence and Gorenstein reduction remain | none; additional hypotheses are explicit |
